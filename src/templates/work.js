			...
			<Outer>
				...
				<Examples>
					{examples && examples.map(example => {
						const isVideoExample = Example && example.indexOf('.mp4') !== -1
						const ExampleComponent = isVideoExample ? Video : Image;
						const componentAttributes = isVideoExample ? { autoPlay: true, playsInline: true, muted: true, loop: true } : {};
						return (
							<Example key={example}>
								<ExampleComponent
									{...componentAttributes}
