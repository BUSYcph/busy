...
export default () => {
	const [setBound] = useState({});
	return (
	<Footer>
		<FooterSection>
			<GoogleMap zoom={17} center={{ lat: 55.679370, lng: 12.579320 }} events={{ onBoundsChangerd: arg => setBound(arg) }}>
				<MapMarker active={true} position={{ lat: 55.679370, lng: 12.579320 }} events={{
					onClick: () => window.alert(`marker clicked`)
				}} />
			</GoogleMap>
		</FooterSection>
		<FooterSectionAddress>
			...
			<a href="https://www.linkedin.com/in/frischbrian/" target="_blank">
				<Picture>
					<img src="/images/brian.png" alt="Brian Frisch" />
				</Picture>
			</a>
		</FooterSectionAddress>
	</Footer>
