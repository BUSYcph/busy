...
export default () => (
	<About>
		...
		<Usp>
			...
			<Description>
				Ok... <em>loving</em> might be stretching it. Let's file that in the &quot;mistakes&quot;. But we will always seek to deliver fast and thereby welcome the risk that follows. We have a pragmatic approach to creation; Build the minimal viable product in order to gain insights and from thereon out improve by repeating the process.
			</Description>
		</Usp>
		<Usp>
