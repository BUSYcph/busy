...
export default () => (
	<Disciplines>
		<Inner>
			...
			<Discipline>🦾<strong>Frontend Code</strong> React, JavaScript, Sketch, HTML, CSS, implementing UI for CMS systems of any kind... you name it.</Discipline>
			...
			<Discipline>👩‍⚕️<strong>Health Checks</strong> Performance Audits, Optimizations</Discipline>
			<Discipline>💼<strong>Other Consulting Stuff</strong> Mentoring, Teaching, Peer Training</Discipline>
			<Discipline>🤹‍♂️<strong>Entertainment</strong> Dumb dad jokes, the Macarena</Discipline>
		</Inner>
	</Disciplines>
)