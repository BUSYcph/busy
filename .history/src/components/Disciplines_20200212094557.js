...
export default () => (
	<Disciplines>
		<Inner>
			...
			<Discipline><strong>UX / Wireframe / Graphical Design</strong> Sketch, Photoshop, Illustrator, Procreate, Animation, etc.</Discipline>
			<Discipline><strong>Health Checks</strong> Performance Audits, Optimizations</Discipline>
			<Discipline><strong>Other Consulting Stuff</strong> Menntoring, Teaching, Peer Training</Discipline>
		</Inner>
	</Disciplines>
)